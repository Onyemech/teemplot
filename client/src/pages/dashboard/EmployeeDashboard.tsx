  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-0">
      ...
      <div className="bg-white p-6 pb-2">
        ...
        {/* Stats Overview */}
        <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-3 md:gap-3">
         ...
         <div className="flex space-x-4">
            ...
            >
             ...
             <button 
                ...
                disabled={clockingIn}
                className={`flex-1 bg-white border-2 font-bold py-3.5 px-4 rounded-xl shadow-sm hover:bg-gray-50 active:bg-gray-100 transition-all flex items-center justify-center space-x-2 ${
