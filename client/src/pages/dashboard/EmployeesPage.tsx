        ...
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-medium transition-colors ${
              activeTab === 'employees'
                ? 'text-[#0F5D5D] border-b-2 border-[#0F5D5D]'
            ...
            <div className="space-y-4">
              {employees.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={() => setShowInviteModal(true)}
                    className="bg-[#0F5D5D] hover:bg-[#0a4444] text-white px-6 py-2 rounded-lg font-medium inline-flex items-center gap-2 transition-colors"
                  >
                    <UserPlus className="w-5 h-5" />
                    ...
                    >
                      <div className="flex items-center gap-4">
                        {employee.avatar ? (
                          ...
                          <div className="w-12 h-12 rounded-full bg-[#0F5D5D] flex items-center justify-center">
