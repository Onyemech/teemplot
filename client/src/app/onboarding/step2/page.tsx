...
//             <span className="text-sm text-gray-700 font-medium">66% Complete</span>
//           </div>
...
//                 <BackButton onClick={handleBack} className="w-full justify-center py-3 px-6 border border-gray-300 rounded-lg hover:bg-gray-50" />
//               </div>
//               <Button
//                 type="button"
//                 variant="primary"
