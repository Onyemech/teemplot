...
//       // Navigate immediately (prefetched)
...
//           <div className="mb-12">
//             <Image src="/logo.png" alt="Teemplot" width={200} height={60} className="h-16 w-auto" />
//           </div>
...
//             <Image src="/logo.png" alt="Teemplot" width={200} height={60} className="h-20 w-auto mx-auto" />
//           </div>
