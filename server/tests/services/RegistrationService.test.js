...
const RegistrationService_1 = require("../../src/services/RegistrationService");
...
describe('RegistrationService', () => {
    ...
    beforeAll(() => {
        ...
        registrationService = new RegistrationService_1.RegistrationService();
    });
    describe('register', () => {
        ...
        it('should register a new company and admin user successfully', async () => {
            ...
            const passwordMatch = await bcrypt_1.default.compare(validRegistrationData.password, user.password_hash);
        ...
        it('should reject duplicate email', async () => {
            ...
            await expect(registrationService.register(validRegistrationData)).rejects.toThrow('Email already registered');
        });
    ...
    describe('resendVerificationCode', () => {
        it('should not throw error for valid email', async () => {
            ...
            await expect(registrationService.resendVerificationCode('resend@test.com')).resolves.not.toThrow();
        });
    });
});
//# sourceMappingURL=RegistrationService.test.js.map